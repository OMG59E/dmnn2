...
#define FMT_CONSTEXPR
    ...
    ((!defined(_GLIBCXX_RELEASE) || _GLIBCXX_RELEASE >= 10) &&                                                    \
     (!defined(_LIBCPP_VERSION) || _LIBCPP_VERSION >= 10000) && (!FMT_MSC_VERSION || FMT_MSC_VERSION >= 1928)) && \
...
public:
    ...
    FMT_INLINE auto format_custom(const char_type* parse_begin, typename Context::parse_context_type& parse_ctx,
                                  Context& ctx) -> bool {
