...
nvinfer1::ITensor *addRNNInput(IImporterContext *ctx, const onnx::NodeProto &node, nvinfer1::ILoop *loop,
...
nvinfer1::ITensor *clearMissingSequenceElements(IImporterContext *ctx, const onnx::NodeProto &node,
...
nvinfer1::ITensor *maskRNNHidden(IImporterContext *ctx, const onnx::NodeProto &node, nvinfer1::ILoop *loop,
                                 nvinfer1::ITensor *seqLens, nvinfer1::ITensor *prevH, nvinfer1::ITensor *Ht,
...
nvinfer1::ITensor *maskBidirRNNHidden(IImporterContext *ctx, const onnx::NodeProto &node, nvinfer1::ILoop *loop,
                                      nvinfer1::ITensor *seqLens, nvinfer1::ITensor *maxLen, nvinfer1::ITensor *Ht1,
    ...
    nvinfer1::ITensor *forwardStart =
        addConstant(ctx, std::vector<int32_t>{0, 0, 0}, onnx::TensorProto::INT32, nvinfer1::Dims{1, 3})->getOutput(0);
    nvinfer1::ITensor *reverseStart =
        addConstant(ctx, std::vector<int32_t>{1, 0, 0}, onnx::TensorProto::INT32, nvinfer1::Dims{1, 3})->getOutput(0);
...
nvinfer1::ITensor *getRaggedMask(IImporterContext *ctx, const onnx::NodeProto &node, nvinfer1::ILoop *loop,
                                 nvinfer1::ITensor *seqLens, nvinfer1::ITensor *maxLen, bool reverse,
                                 nvinfer1::ITensor *counter) {
    ...
    if (reverse) {
        counter = ctx->network()
                      ->addElementWise(*unsqueezeTensor(ctx, node, *maxLen, {0}), *counter,
