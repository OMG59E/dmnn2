/***
 * @Author: xingwg
 * @Date: 2024-12-13 08:34:38
 * @LastEditTime: 2024-12-13 14:39:33
 * @FilePath: /dmnn2/src/parsers/onnx/trt_utils.hpp
 * @Description:
 * @
...
inline int getDtypeSize(nvinfer1::DataType trtDtype) {
    ...
    case nvinfer1::DataType::kINT32:
        return 4;
    // TRT does not support booleans as a native type, so we treat them like
    // int32 values.
...
inline nvinfer1::Dims insert_dim(nvinfer1::Dims const &dims, int idx,
                                 int value) {
