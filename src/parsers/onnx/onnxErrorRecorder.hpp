/***
 * @Author: xingwg
 * @Date: 2024-12-12 16:15:13
 * @LastEditTime: 2024-12-12 16:15:21
 * @FilePath: /dmnn2/src/parsers/onnx/onnxErrorRecorder.hpp
 * @Description:
 * @
...
public:
    static ONNXParserErrorRecorder *
    create(ILogger *logger, IErrorRecorder *otherRecorder = nullptr);
    ...
    bool hasOverflowed() const noexcept final {
        // This class can never overflow since we have dynamic resize via
        // std::vector usage.
        return false;
    }

protected:
    ONNXParserErrorRecorder(ILogger *logger,
                            IErrorRecorder *otherRecorder = nullptr);
