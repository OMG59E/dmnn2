/***
 * @Author: xingwg
 * @Date: 2024-12-12 17:05:10
 * @LastEditTime: 2024-12-12 17:05:45
 * @FilePath: /dmnn2/src/parsers/onnx/ShapeTensor.cpp
 * @Description:
 * @
...
//! This is a hack to get shape tensor working with float values with minimal
//! changes. The constructed ShapeTensor has the following properties:
//! 1. mAllValuesKnown == false
//! 2. mValues.size() == 0
//! 3. mIsFloat == true
//!
//! Float shape tensor does not have any constant folding in parser as available
//! to int32_t shape tensors. Instead, rely on builder for constant folding and
...
//! Helper that implements an elementwise operations on two shape tensors x and
...
static ShapeTensor op(IImporterContext *ctx, const ShapeTensor &x,
    ...
    // subsequent logic, which can assume the size of the result is the max of
