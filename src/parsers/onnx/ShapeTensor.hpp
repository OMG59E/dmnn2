/***
 * @Author: xingwg
 * @Date: 2024-12-12 16:22:37
 * @LastEditTime: 2024-12-12 16:30:05
 * @FilePath: /dmnn2/src/parsers/onnx/ShapeTensor.hpp
 * @Description:
 * @
...
public:
    ...
    bool rankKnown() const { return mRank != kRANK_UNKNOWN; }
    ...
    bool sizeKnown() const { return mSize != kSIZE_UNKNOWN; }
    ...
    bool allValuesKnown() const { return mAllValuesKnown; }
...
private:
    //! Number of IShapeLayer to apply to mTensor to get ITensor representing
    //! value of *this. -1 for undefined *this, a value in [0,2] otherwise. 0:
    //! *this represents value of the tensor (always 0D or 1D) 1: *this
    //! represents shape of mTensor (always 1D) 2: *this represents rank of
    //! mTensor (always 1D tensor of length 1)
...
//! Return product of x[i] for i in [first..last), as 0D or one-element 1D
//! tensor of given rank.
...
inline ShapeTensor interlace(IImporterContext *ctx, const ShapeTensor &x,
                             const ShapeTensor &y,
