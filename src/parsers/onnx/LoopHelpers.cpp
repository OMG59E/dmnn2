/***
 * @Author: xingwg
 * @Date: 2024-12-13 10:01:32
 * @LastEditTime: 2024-12-13 10:01:42
 * @FilePath: /dmnn2/src/parsers/onnx/LoopHelpers.cpp
 * @Description:
 * @
...
nvinfer1::ITensor *addLoopCounter(IImporterContext *ctx, nvinfer1::ILoop *loop,
    ...
    nvinfer1::ITensor *initialTensor =
        addConstantScalar(ctx, initial, onnx::TensorProto::INT32,
                          nvinfer1::Dims{1, 1})
            ->getOutput(0);
    nvinfer1::ITensor *one =
        addConstantScalar(ctx, 1, onnx::TensorProto::INT32,
                          nvinfer1::Dims{1, 1})
            ->getOutput(0);
    ...
    nvinfer1::ITensor *addOne =
        ctx->network()
            ->addElementWise(*counter->getOutput(0), *one,
