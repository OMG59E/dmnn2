 ...
 * @LastEditTime: 2024-12-12 15:07:39
 * @FilePath: /dmnn2/src/parsers/common/parserUtils.h
 * @Description:
 * @
...
inline nv::DimsCHW getCHW(const nvinfer1::Dims &d) {
    if (d.nbDims != 3)
        LOG_FATAL("Invalid dims {}, must be = 3", d.nbDims);
