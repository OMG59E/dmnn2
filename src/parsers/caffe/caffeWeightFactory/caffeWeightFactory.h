...
public:
    CaffeWeightFactory(const trtcaffe::NetParameter &msg, nvinfer1::DataType dataType, std::vector<void *> &tmpAllocs,
                       bool isInitialized);
    ...
    nvinfer1::Weights allocateWeights(int64_t elems, std::uniform_real_distribution<float> distribution =
    ...
    static std::pair<const void *, size_t> getBlobProtoData(const trtcaffe::BlobProto &blobMsg, trtcaffe::Type type,
