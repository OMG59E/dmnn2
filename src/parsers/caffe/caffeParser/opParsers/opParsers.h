...
inline bool checkBlobs(const trtcaffe::LayerParameter &msg, int bottoms, int tops) {
    if (msg.bottom_size() != bottoms) {
        LOG_INFO("{}: expected {} bottom blobs, found {}", msg.name(), bottoms, msg.bottom_size());
        return false;
    }

    if (msg.top_size() != tops) {
        LOG_INFO("{}: expected {} tops blobs, found {}", msg.name(), tops, msg.top_size());
        return false;
    }
    return true;
}

typedef ILayer *(*LayerParseFn)(INetworkDefinition &, const trtcaffe::LayerParameter &, CaffeWeightFactory &,
                                BlobNameToTensor &);

ILayer *parseAbsVal(INetworkDefinition &network, const trtcaffe::LayerParameter &msg, CaffeWeightFactory &,
...
ILayer *parseBNLL(INetworkDefinition &network, const trtcaffe::LayerParameter &msg, CaffeWeightFactory &,
                  BlobNameToTensor &tensors);
ILayer *parseClip(INetworkDefinition &network, const trtcaffe::LayerParameter &msg, CaffeWeightFactory &,
                  BlobNameToTensor &tensors);
ILayer *parseConcat(INetworkDefinition &network, const trtcaffe::LayerParameter &msg, CaffeWeightFactory &,
                    BlobNameToTensor &tensors);
ILayer *parseConvolution(INetworkDefinition &network, const trtcaffe::LayerParameter &msg,
                         CaffeWeightFactory &weightFactory, BlobNameToTensor &tensors);
ILayer *parseCrop(INetworkDefinition &network, const trtcaffe::LayerParameter &msg, CaffeWeightFactory &,
                  BlobNameToTensor &tensors);
ILayer *parseDeconvolution(INetworkDefinition &network, const trtcaffe::LayerParameter &msg,
                           CaffeWeightFactory &weightFactory, BlobNameToTensor &tensors);
ILayer *parseEltwise(INetworkDefinition &network, const trtcaffe::LayerParameter &msg, CaffeWeightFactory &,
                     BlobNameToTensor &tensors);
ILayer *parseELU(INetworkDefinition &network, const trtcaffe::LayerParameter &msg, CaffeWeightFactory &,
                 BlobNameToTensor &tensors);
ILayer *parseInnerProduct(INetworkDefinition &network, const trtcaffe::LayerParameter &msg,
                          CaffeWeightFactory &weightFactory, BlobNameToTensor &tensors);
ILayer *parseLRN(INetworkDefinition &network, const trtcaffe::LayerParameter &msg, CaffeWeightFactory &,
                 BlobNameToTensor &tensors);
ILayer *parsePermute(INetworkDefinition &network, const trtcaffe::LayerParameter &msg, CaffeWeightFactory &,
                     BlobNameToTensor &tensors);
ILayer *parsePooling(INetworkDefinition &network, const trtcaffe::LayerParameter &msg, CaffeWeightFactory &,
                     BlobNameToTensor &tensors);
...
ILayer *parseScale(INetworkDefinition &network, const trtcaffe::LayerParameter &msg, CaffeWeightFactory &weightFactory,
                   BlobNameToTensor &tensors);
ILayer *parseSigmoid(INetworkDefinition &network, const trtcaffe::LayerParameter &msg,
                     CaffeWeightFactory & /*weightFactory*/, BlobNameToTensor &tensors);
ILayer *parseSoftMax(INetworkDefinition &network, const trtcaffe::LayerParameter &msg,
                     CaffeWeightFactory & /*weightFactory*/, BlobNameToTensor &tensors);
ILayer *parseTanH(INetworkDefinition &network, const trtcaffe::LayerParameter &msg,
                  CaffeWeightFactory & /*weightFactory*/, BlobNameToTensor &tensors);
