...
ILayer *parseDeconvolution(INetworkDefinition &network,
    ...
    int kernelH = p.has_kernel_h()           ? p.kernel_h()
    ...
    Weights kernelWeights =
        weightFactory.isInitialized()
            ...
            : weightFactory.allocateWeights(
                  kernelW * kernelH * C * nbOutputs / nbGroups,
    ...
    auto *layer = network.addDeconvolution(*tensors[msg.bottom(0)], nbOutputs,
