 ...
 * @LastEditTime: 2024-10-12 09:02:27
 * @FilePath: /dmnn2/src/parsers/caffe/caffeParser/opParsers/parseReduction.cpp
 * @Description:
 * @
...
ILayer *parseReduction(INetworkDefinition &network,
    ...
    const int ASUM = 2;
    // operation == 3 is SUMSQ -> ElementWiseOperation::kPROD and
