...
public:
    explicit YOLODetectionOutputV2(YOLODetectionOutputV2Parameters param) : param(param) {}

    YOLODetectionOutputV2(YOLODetectionOutputV2Parameters param, int C1, int C2) : param(param), C1(C1), C2(C2) {}
    ...
    size_t getWorkspaceSize(int maxBatchSize) const noexcept override {
        return detectionInferenceWorkspaceSize(maxBatchSize, C1, C2, param.num_classes, param.num_pts, param.topK,
    ...
    size_t getSerializationSize() const noexcept override {
        return sizeof(YOLODetectionOutputV2Parameters) + sizeof(int) * 2;
    }
    ...
    const char *getPluginType() const noexcept override {
        return YOLO_NMS_PLUGIN_V2_NAME;
    }
    const char *getPluginVersion() const noexcept override {
        return YOLO_NMS_PLUGIN_V2_VERSION;
    }
...
public:
    explicit YOLODetectionOutputDynamicV2(YOLODetectionOutputV2Parameters param) : param(param) {}
    ...
    size_t getWorkspaceSize(nvinfer1::PluginTensorDesc const *inputs, int32_t nbInputs,
        ...
        return detectionInferenceWorkspaceSize(inputs[0].dims.d[0], C1, C2, param.num_classes, param.num_pts,
    ...
    const char *getPluginType() const noexcept override {
        return YOLO_NMS_DYNAMIC_PLUGIN_V2_NAME;
    }
    const char *getPluginVersion() const noexcept override {
        return YOLO_NMS_PLUGIN_V2_VERSION;
    }
