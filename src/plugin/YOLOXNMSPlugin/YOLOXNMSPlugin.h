...
public:
    explicit YOLOXDetectionOutput(YOLOXDetectionOutputParameters param) : param(param) {}
    YOLOXDetectionOutput(YOLOXDetectionOutputParameters param, int C1, int C2) : param(param), C1(C1), C2(C2) {}
    ...
    size_t getSerializationSize() const noexcept override {
        return sizeof(YOLOXDetectionOutputParameters) + sizeof(int) * 2;
    }
    ...
    const char *getPluginType() const noexcept override {
        return YOLOX_NMS_PLUGIN_NAME;
    }
    const char *getPluginVersion() const noexcept override {
        return YOLOX_NMS_PLUGIN_VERSION;
    }
