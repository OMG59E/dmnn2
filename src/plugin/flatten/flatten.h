...
public:
    Flatten(int channel_in, int height_in, int width_in, int axis, int end_axis)
        : channel_in_{channel_in}, height_in_{height_in}, width_in_{width_in}, axis_{axis}, end_axis_{end_axis} {}
    ...
    int enqueue(int batchSize, void const *const *inputs, void *const *outputs, void *workspace,
        ...
        CUDACHECK(cudaMemcpyAsync(output, input, channel_in_ * height_in_ * width_in_ * batchSize * sizeof(float),
    ...
    const char *getPluginType() const noexcept override {
        return FLATTEN_PLUGIN_NAME;
    }
    const char *getPluginVersion() const noexcept override {
        return FLATTEN_PLUGIN_VERSION;
    }
