...
public:
    explicit YOLODetectionOutput(YOLODetectionOutputParameters param) : param(param) {}
    YOLODetectionOutput(YOLODetectionOutputParameters param, int C1, int C2) : param(param), C1(C1), C2(C2) {}
    ...
    size_t getWorkspaceSize(int maxBatchSize) const noexcept override {
        return detectionInferenceWorkspaceSize(maxBatchSize, C1, C2, param.num_classes, param.topK, DataType::kFLOAT,
                                               DataType::kFLOAT);
    }
    int enqueue(int batchSize, void const *const *inputs, void *const *outputs, void *workspace,
                cudaStream_t stream) noexcept override;
    size_t getSerializationSize() const noexcept override {
        return sizeof(YOLODetectionOutputParameters) + sizeof(int) * 2;
    }
...
public:
    explicit YOLODetectionOutputDynamic(YOLODetectionOutputParameters param) : param(param) {}

    YOLODetectionOutputDynamic(YOLODetectionOutputParameters param, int C1, int C2) : param(param), C1(C1), C2(C2) {}
    ...
    size_t getWorkspaceSize(nvinfer1::PluginTensorDesc const *inputs, int32_t nbInputs,
        ...
        return detectionInferenceWorkspaceSize(inputs[0].dims.d[0], C1, C2, param.num_classes, param.topK,
    ...
    const char *getPluginType() const noexcept override {
        return YOLO_NMS_DYNAMIC_PLUGIN_NAME;
    }
    const char *getPluginVersion() const noexcept override {
        return YOLO_NMS_PLUGIN_VERSION;
    }
