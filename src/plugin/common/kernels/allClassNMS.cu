 ...
 * @LastEditTime: 2024-10-12 10:18:38
 * @FilePath: /dmnn2/src/plugin/common/kernels/allClassNMS.cu
 * @Description:
 *
...
__global__ void allClassNMS_kernel(const int num, const int num_classes, const int num_preds_per_class, const int top_k,
                                   ...
                                   int *afterNMS_index_array, bool flipXY = false) {
...
#define P(tsize) allClassNMS_kernel<T_SCORE, T_BBOX, (tsize)>
    ...
    void (*kernel[8])(const int, const int, const int, const int, const float, const bool, const bool, float *,
                      T_SCORE *, int *, T_SCORE *, int *, bool) = {P(1), P(2), P(3), P(4), P(5), P(6), P(7), P(8)};
    ...
    kernel[t_size - 1]<<<GS, BS, BS * t_size * sizeof(bool), stream>>>(
        ...
        (T_SCORE *)beforeNMS_scores, (int *)beforeNMS_index_array, (T_SCORE *)afterNMS_scores,
        (int *)afterNMS_index_array, flipXY);
...
typedef pluginStatus_t (*nmsFunc)(cudaStream_t, const int, const int, const int, const int, const float, const bool,
                                  const bool, void *, void *, void *, void *, void *, bool);
...
bool nmsInit() {
    nmsFuncVec.push_back(nmsLaunchConfigSSD(DataType::kFLOAT, DataType::kFLOAT, allClassNMS_gpu<float, float>));
    return true;
}
...
pluginStatus_t allClassNMS(cudaStream_t stream, const int num, const int num_classes, const int num_preds_per_class,
                           const int top_k, const float nms_threshold, const bool share_location,
                           const bool isNormalized, const DataType DT_SCORE, const DataType DT_BBOX, void *bbox_data,
    ...
    for (unsigned i = 0; i < nmsFuncVec.size(); ++i) {
        if (lc == nmsFuncVec[i]) {
            return nmsFuncVec[i].function(stream, num, num_classes, num_preds_per_class, top_k, nms_threshold,
