 ...
 * @LastEditTime: 2024-10-12 10:41:00
 * @FilePath: /dmnn2/src/plugin/common/kernels/permuteData.cu
 * @Description:
 *
...
__launch_bounds__(nthds_per_cta) __global__
    void permuteData_kernel(const int nthreads, const int num_classes, const int num_data, const int num_dim,
...
pluginStatus_t permuteData_gpu(cudaStream_t stream, const int nthreads, const int num_classes, const int num_data,
                               const int num_dim, bool confSigmoid, const void* data, void* new_data) {
    const int BS = 512;
...
pluginStatus_t permuteData(cudaStream_t stream, const int nthreads, const int num_classes, const int num_data,
                           const int num_dim, const DataType DT_DATA, bool confSigmoid, const void* data,
                           void* new_data) {
