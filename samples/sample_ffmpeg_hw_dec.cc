 ...
 * @LastEditTime: 2024-12-17 10:26:54
 * @FilePath: /dmnn2/samples/sample_ffmpeg_hw_dec.cc
 * @Description:
 *
...
int main(int argc, char **argv) {
    ...
    nv::FFmpegDecoder dec;
    if (0 != dec.open(video_path, device_id)) {
    ...
    LOG_INFO("total decoded frames: {}, diff: {}", dec.total_decoded_frames(),
             std::abs(dec.total_frames() - dec.total_decoded_frames()));
    return 0;
}